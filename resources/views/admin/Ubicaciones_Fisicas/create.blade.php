...
@section('content')
    ...
    <form class="row g-3" action="{{route('ubicaiones_fisicas.store')}}" method="POST">
        @csrf
  <div class="col-md-3">
  ...
  <div class="col-md-3">
    ...
    <input name="descripcion" type="text" class="form-control" id="descripcion" placeholder="Escribe una breve descripción" required>
  </div>
